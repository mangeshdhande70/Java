...
class MyThread1 extends Thread{
    ...
    public MyThread1(Ticket1 ticket,String name){
        this.ticket = ticket;
        this.name = name;
    }
...
public class TrainTicketUsingClassLevelLock {
    public static void main(String[] args) {
        ...
        MyThread1 myThread1 =  new MyThread1(ticket1,"Ankit");

        MyThread1 myThread2 = new MyThread1(ticket2,"Rakesh");
